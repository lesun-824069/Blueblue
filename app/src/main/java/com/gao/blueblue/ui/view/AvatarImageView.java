...
/**
 * @program: Blueblue
 * @description:圆角图片类，主要用于显示聊天头像
 * @author: wuzewen
 * @create: 2021-10-16 00:00
 **/
public class AvatarImageView extends AppCompatImageView {
    private Paint paint;

    public int roundWidth = 20;
    public int roundHeight = 20;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            roundWidth = a.getDimensionPixelSize(R.styleable.AvatarImageView_roundWidth, roundWidth);
            roundHeight = a.getDimensionPixelSize(R.styleable.AvatarImageView_roundHeight, roundHeight);
        } else {
